...
urlpatterns = [
    ...
    # FIXED: Admin authentication with proper names
    ...
    # Quick teacher approval actions from dashboard
    path('quick-approve-teacher/<int:teacher_id>/', views.quick_approve_teacher, name='quick-approve-teacher'),
    path('quick-reject-teacher/<int:teacher_id>/', views.quick_reject_teacher, name='quick-reject-teacher'),
    path('quick-delete-teacher/<int:teacher_id>/', views.quick_delete_teacher, name='quick-delete-teacher'),
